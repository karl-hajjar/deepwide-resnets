...
class MuPResidual(Residual):
    """
    A class defining a residual block consisting of two fully-connected layers in the Maximal Update (MuP)
    parameterization followed by a residual connection: that is, for an input x, the output of the residual layer is
    x + alpha * W_2 phi(W_1 x + b_1) + b_2.
    """
